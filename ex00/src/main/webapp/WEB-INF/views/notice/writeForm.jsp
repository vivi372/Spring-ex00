...
<script type="text/javascript">
	$(function() { // == $(document).ready(function(){~});		
		...
		let yearRange = (endYear - 10) +":" + endYear ;					
...
<div class="container">
	...
	<h3><i class="fa fa-pencil-square-o"></i>공지사항 글 등록</h3>
	<form action="/notice/write.do" method="post" id="writeForm">
		...
		<div class="form-group">
			...
			<div class="form-inline">
				<input type="text" class="form-control datepicker" placeholder="시작일" id="startDate" name="startDate" required autocomplete="off">	
				<span class="mx-3"> ~ </span>		
				<input type="text" class="form-control datepicker" placeholder="종료일" id="endDate" name="endDate" required autocomplete="off">		
		...
		<div class="btn-group">
			<!-- 등록 버튼을 클릭하면 1. click-btn 2.submit-form 이벤트로 처리 가능하다. -->
 			...
 			<button type="reset" class="btn btn-light">초기화</button>
  			<button type="button" class="btn btn-secondary" onclick="location='/notice/list.do?period=${param.period }&page=${param.page }&perPageNum=${param.perPageNum }&key=${param.key }&word=${param.word }';">취소</button>
		</div>		
	</form>
	</div>
</div>
